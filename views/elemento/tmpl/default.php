...
if ($this->elemento['track']['stato']) {
    ...
    <script type="text/javascript">
        var player_features = ['playpause','progress','current','duration','tracks','volume','fullscreen'];
    </script>
    <?php
} else {
    ?>
    <script type="text/javascript">
        var player_features = ['playpause','current','duration','tracks','volume','fullscreen'];
    </script>
    <?php
}
...
$document->addScript('components/com_gglms/js/fullscreen.js');
