...
require_once('components/com_gglms/models/libs/pdf/tcpdf/config/lang/ita.php');
require_once('components/com_gglms/models/libs/pdf/tcpdf/tcpdf.php');
...
class certificatePDF extends TCPDF {
     ...
     */
    public function fetch_pdf_template($template, $cache_id = null, $check = false, $cache = true, $lifetime = 120) {
        $this->AddPage();
