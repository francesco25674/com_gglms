...
class gglmsModelattestato extends JModel {
	 ...
	 */
	public function certificate($userid, $itemid, $template = 'attestato_frequenza.tpl') {
		try {
	...
	*/
	...
	private function _get_track_total($id_corso) {
		try {
			$query =	'(SELECT
							" " as id, 
							"<b> TOTALE  </b>" as elemento,
							" " as data,
							SEC_TO_TIME(sum(tview)) as tview
